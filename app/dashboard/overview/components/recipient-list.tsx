...
export default function RecipientList() {
  return (
    <div className="w-full h-[127px] flex justify-between items-center">
      ...
      <button className="size-[40px] xl:size-[50px] cursor-pointer bg-white rounded-full flex items-center justify-center shadow-[4px_4px_18px_-2px_rgba(231,228,232,0.8)]">
